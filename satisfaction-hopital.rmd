...
barplot(tabService*100,
        ...
        las=2,
        main="proportion du nombre de patients accueilli par chaque service ",
        border ="blue",
        col="pink"
)
```
...
Lors de cette étude avons pu analyser différentes variables issus du jeu de données. Nous avons pu extraire des informations en étudiant plusieurs variables comme la profession, le sexe, l'âge des patients. Nous avons également pu voir les liens entre différentes variables, comme la variation du score de la qualité des relations en fonction du sexe ou de l'âge ou encore la variation du score de la qualité de l'information reçue par les patients en fonction de la profession.